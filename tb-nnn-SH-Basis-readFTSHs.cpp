...
double residual(double params[10], double neighbors[4][3], double next_neighbors[12][3], 
	double kx, double ky, double kz, int point, double dft_bands[P][24], double dft_band_eigenvectors[P][24][N], proj_bandvecs TB_Proj){
...
int main(){
	...
	// 	for(int i = 0; i < 5; i++){
	// 		res += residual(new_params, neighbors, next_neighbors, fit_points[i][0], fit_points[i][1], fit_points[i][2], points[i] ,dft_bands, dft_band_eigenvectors, TB_Proj);
	// 	}	
